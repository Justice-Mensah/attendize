...
use App\Http\Controllers\EventsSpeakersController;
...
Route::group(
    ...
    Route::group(['middleware' => ['auth', 'first.run']], function () {
        ...
        Route::group(['prefix' => 'event'], function () {
            ...
            [EventsSpeakersController::class, 'index']
        )->name('showEventSpeakers');

        Route::get('{event_id}/speakers/edit/{speaker_id}',
            [EventsSpeakersController::class, 'edit']
        )->name('showEditSpeaker');

        Route::post('{event_id}/speakers/edit/{speaker_id}',
            [EventsSpeakersController::class, 'update']
        )->name('postEditSpeaker');

        Route::get('{event_id}/speakers/create',
            [EventsSpeakersController::class, 'create']
        )->name('showCreateSpeaker');

        Route::post('{event_id}/speakers/create',
            [EventsSpeakersController::class, 'store']
        )->name('postCreateSpeaker');

        Route::get('{speaker_id}/speakers/delete',
            [EventsSpeakersController::class, 'destroy']
